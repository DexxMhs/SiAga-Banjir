...
@section('breadcrumbs')
    ...
    <a class="text-sm font-medium text-slate-500 hover:text-primary dark:text-[#8e99cc]"
        href="{{ route('stations.index') }}">Manajemen Pos Pantau</a>
    <span class="material-symbols-outlined text-sm ...">chevron_right</span>
    <span class="text-sm font-medium text-slate-900 dark:text-white">Tambah Pos Pantau</span>
@endsection
                ...
                <div class="mx-auto max-w-5xl">
                    ...
                    <div class="mb-8 flex flex-col gap-2">
                        <h1 class="text-3xl md:text-4xl font-black text-gray-900 dark:text-white tracking-tight">
                            Tambah Pos Pantau Baru
                        </h1>
                        <p class="text-base text-gray-500 dark:text-[#9ba0bb]">
                            Isi formulir di bawah untuk mendaftarkan pos pantau baru
                            ke dalam sistem.
                        </p>
                    </div>
                    ...
                    <form action="{{ route('stations.store') }}" method="POST"
                        ...
                        @csrf
                        @include('admin.pages.stations.partials.form')
                        <!-- Footer Actions -->
                        <div
