...
@section('breadcrumbs')
    ...
    <span class="material-symbols-outlined text-sm ...">chevron_right</span>
    <span class="text-sm font-medium text-slate-900 dark:text-white">Edit Pos Pantau</span>
@endsection
                ...
                <div class="mx-auto max-w-5xl">
                    ...
                    <div class="mb-8 flex flex-col gap-2">
                        <h1 class="text-3xl md:text-4xl font-black text-gray-900 dark:text-white tracking-tight">
                            Edit Pos Pantau Baru
                        </h1>
                        <p class="text-base text-gray-500 dark:text-[#9ba0bb]">
                            Isi formulir di bawah untuk perbarui data pos pantau
                            di dalam sistem.
                        </p>
                    </div>
