...
@section('breadcrumbs')
    ...
    <a class="text-sm font-medium text-slate-500 hover:text-primary dark:text-[#8e99cc]"
        href="{{ route('regions.index') }}">Manajemen Wilayah</a>
    <span class="material-symbols-outlined text-sm text-slate-500">chevron_right</span>
    <span class="text-sm font-medium text-slate-900 dark:text-white">Tambah Wilayah</span>
@endsection
            ...
            <div class="flex-1 overflow-y-auto p-6 md:p-10">
                <div class="mx-auto max-w-5xl">
                    ...
                    <div class="mb-8 flex flex-col gap-2">
                        ...
                        <p class="text-base text-gray-500 dark:text-[#9ba0bb]">
                            Daftarkan wilayah baru, tentukan koordinat, dan hubungkan dengan pos pantau terkait.
                        </p>
                    </div>
                    ...
                    <form action="{{ route('regions.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        @include('admin.pages.regions.partials.form')
                ...
                <footer class="mt-12 mb-6 text-center">
                    <p class="text-sm text-gray-400 dark:text-gray-600">
                        © {{ date('Y') }} Sistem Monitoring Banjir. All rights reserved.
                    </p>
                </footer>
            </div>
        </main>
