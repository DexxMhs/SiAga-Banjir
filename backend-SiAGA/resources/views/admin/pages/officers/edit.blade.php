                            ...
                            <div class="flex flex-col md:flex-row gap-6 items-center md:items-start">
                                <div class="relative group">
                                    <div id="imagePreview"
                                        ...
                                        style="background-image: url('{{ $officer->photo ? asset('storage/' . $officer->photo) : 'https://ui-avatars.com/api/?name=' . urlencode($officer->name) . '&color=7F9CF5&background=EBF4FF' }}');">
                                    </div>
                                ...
                                <div class="flex flex-col justify-center gap-2">
                                    <p class="text-white font-medium text-lg">{{ $officer->name }}</p>
...
@section('script')
    <script>
        ...
        function deletePhoto() {
            ...
            const defaultAvatar =
                'https://ui-avatars.com/api/?name={{ urlencode($officer->name) }}&color=7F9CF5&background=EBF4FF';
