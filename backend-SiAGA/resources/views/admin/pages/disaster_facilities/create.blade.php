...
@section('breadcrumbs')
    ...
    <span class="material-symbols-outlined text-sm text-slate-500">chevron_right</span>
    <span class="text-sm font-medium text-slate-900 dark:text-white">Tambah Fasilitas</span>
@endsection
                ...
                <div class="mx-auto max-w-5xl">
                    ...
                    <div class="mb-8 flex flex-col gap-2">
                        <h1 class="text-3xl md:text-4xl font-black text-gray-900 dark:text-white tracking-tight">
                            Tambah Fasilitas Bencana
                        </h1>
                        <p class="text-base text-gray-500 dark:text-[#9ba0bb]">
                            Daftarkan posko pengungsian, dapur umum, atau fasilitas kesehatan baru ke dalam sistem.
                        </p>
                    </div>
                    ...
                    <form action="{{ route('disaster-facilities.store') }}" method="POST" enctype="multipart/form-data"
