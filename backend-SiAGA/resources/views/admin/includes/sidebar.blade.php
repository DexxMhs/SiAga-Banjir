...
<aside
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 flex flex-col gap-1">
        ...
        <a class="@if (Request::segment(2) == 'officer') flex items-center gap-3 px-3 py-3 rounded-lg bg-primary text-white shadow-lg shadow-primary/30 @else flex items-center gap-3 px-3 py-3 rounded-lg text-slate-600 dark:text-[#8e99cc] hover:bg-slate-100 dark:hover:bg-surface-dark transition-colors group @endif"
            href="#">
        ...
        <a class="@if (Request::segment(1) == 'region') flex items-center gap-3 px-3 py-3 rounded-lg bg-primary text-white shadow-lg shadow-primary/30 @else flex items-center gap-3 px-3 py-3 rounded-lg text-slate-600 dark:text-[#8e99cc] hover:bg-slate-100 dark:hover:bg-surface-dark transition-colors group @endif"
        ...
        <a class="@if (Request::segment(1) == 'reports') flex items-center gap-3 px-3 py-3 rounded-lg bg-primary text-white shadow-lg shadow-primary/30 @else flex items-center gap-3 px-3 py-3 rounded-lg text-slate-600 dark:text-[#8e99cc] hover:bg-slate-100 dark:hover:bg-surface-dark transition-colors group @endif"
            href="#">
